...
data_file3 = open(path + path_output + '/processed' + '/Correlated_features_{}50.csv'.format(data_name), mode='w',
                  newline='',
                  encoding='utf-8')
...
for feature_ in feature_list:
    ...
    for swap_prop, val2_ in val.items():
        if swap_prop in swap_selected:
            ...
            row_cramers_v = ['{}%'.format(swap_prop), "Contingency coefficient", feature_]
            ...
            row_effect_distance_constained = ['{}%'.format(swap_prop), 'Effect distance constrained', feature_]
                ...
                if feature_ + '/' + feature_2 in data_probability_mapping_NDI.keys():
                    ...
                    if feature_list.index(feature_) < feature_list.index(feature_2):
                        ...
                        row_hellinger.append(str(
                            round(data_probability_mapping_NDI_NII[feature_ + '/' + feature_2][swap_prop][
                                      'hellinger'] + val_h,
                                  2)))
                        ...
                        row_total_variation.append(str(
                            round(data_probability_mapping_NDI_NII[feature_ + '/' + feature_2][swap_prop][
                                  ...
                                  2)))
                        row_js.append(str(
                            round(data_probability_mapping_NDI_NII[feature_ + '/' + feature_2][swap_prop]['JS'] + val_s,
                                  2)))
            ...
            row_hellinger.append(round(hellinger_NDI_NII_mean,3))
            row_wasserstein.append(round(wasserstein_NDI_NII_mean,3))
            row_total_variation.append(round(total_variation_NDI_NII_mean,3))
            row_js.append(round(JS_NDI_NII_mean,3))
