...
data_writer.writerow(['ID','Features','Swap', 'Swap_ratio', 'Distance_measure', 'Value', 'Normalized'])
...
for i in range(len(Feature)):
    ...
    if Feature[i] in data_dict_overal.keys():
        if swap_proportion[i] in data_dict_overal[Feature[i]].keys():
            data_dict_overal[Feature[i]][swap_proportion[i]][Category[i]] = [hellinger_div_norm, wasserstein_div_norm, cramers_v_div_norm, total_variation_div_norm, JS_Div_norm, Casuality[i], Importance[i]]
        else:
            data_dict_overal[Feature[i]][swap_proportion[i]] = {}
            data_dict_overal[Feature[i]][swap_proportion[i]][Category[i]] = [hellinger_div_norm, wasserstein_div_norm, cramers_v_div_norm, total_variation_div_norm, JS_Div_norm, Casuality[i],
                                                                             Importance[i]]
