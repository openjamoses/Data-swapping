...
df_global = pd.read_csv(path + 'logging3/Divergence_improved_2_local_{}.csv'.format(data_name))
...
data_writer2.writerow(
    ['Feature', 'Swap \n Percentage', 'Metric', 'CDI', 'NDI', 'NII', 'Impact_Sum', 'AVERAGE', 'NDI2', 'NII2'])
data_file3 = open(path + path_output + '/processed' + '/Correlated_features_{}.csv'.format(data_name), mode='w',
                  newline='',
                  encoding='utf-8')
...
for feature_ in feature_set:
    ...
    for swap_, val2_ in val.items():
        ...
        direct_effect_distance_contrained = np.mean(
            data_direct_effect_distance_contrained[feature_][swap_][feature_][type_])
        ...
        for feature_2 in feature_set:
            ...
            if feature_ in data_indirect_hellinger.keys():
                if feature_2 != feature_ and feature_2 in data_indirect_hellinger[feature_][
                    ...
                    NDI_effect_distance_contrained = np.mean(
                        data_indirect_effect_distance_contrained[feature_][swap_][feature_2][type_NDI])
    ...
    for swap_prop, val2_ in val.items():
        if swap_prop in swap_selected:
                ...
                if feature_ + '/' + feature_2 in data_probability_mapping_NDI.keys():
                    ...
                    row_total_variation.append(str(
                        round(data_probability_mapping_NDI[feature_ + '/' + feature_2][swap_prop]['total_variation'],
                              4)) + '/' + str(
                        round(data_probability_mapping_NII[feature_ + '/' + feature_2][swap_prop]['total_variation'],
                              4)))
                    row_js.append(str(
                    ...
                    row_effect_distance.append(str(
                        round(data_probability_mapping_NDI[feature_ + '/' + feature_2][swap_prop]['effect_distance'],
                              4)) + '/' + str(
                        round(data_probability_mapping_NII[feature_ + '/' + feature_2][swap_prop]['effect_distance'],
                              4)))
                    row_effect_distance_constained.append(str(
                        round(
                            data_probability_mapping_NDI[feature_ + '/' + feature_2][swap_prop]['distance_contrained'],
                            4)) + '/' + str(
                        round(
                            data_probability_mapping_NII[feature_ + '/' + feature_2][swap_prop]['distance_contrained'],
                            4)))
            ...
            row_effect_distance.append(data_probability_mapping_CDI[feature_][swap_prop][
                                           'effect_distance'] + (
                                                   effect_distance_NDI_mean + effect_distance_NII_mean) / 2)
            row_effect_distance.append(
                (data_probability_mapping_CDI[feature_][swap_prop][
                     'effect_distance'] + effect_distance_NDI_NII_mean) / 2)
            ...
            row_effect_distance_constained.append('')
            row_effect_distance_constained.append(
                data_probability_mapping_CDI[feature_][swap_prop]['distance_contrained'])
            row_effect_distance_constained.append(
                data_probability_mapping_CDI[feature_][swap_prop][
                    'distance_contrained'] + effect_distance_constained_NDI_mean)
            row_effect_distance_constained.append(data_probability_mapping_CDI[feature_][swap_prop][
                                                      'distance_contrained'] + (
                                                              effect_distance_constained_NDI_mean + effect_distance_constained_NII_mean) / 2)
            row_effect_distance_constained.append(
                (data_probability_mapping_CDI[feature_][swap_prop][
                     'distance_contrained'] + effect_distance_constained_NDI_NII_mean) / 2)
            ...
            data_writer.writerow(
                [feature_, '{}%'.format(swap_prop), "Contingency\n coefficient(-)",
                 ...
                 cramers_v_NII_mean,
                 data_probability_mapping_CDI[feature_][swap_prop][
                     'cramers_v'] + cramers_v_NDI_mean * cramers_v_NII_mean,
                 (data_probability_mapping_CDI[feature_][swap_prop][
