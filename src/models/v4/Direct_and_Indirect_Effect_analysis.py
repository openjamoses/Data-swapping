...
class SensitivityAnalysis:
    def __init__(self, data,df_data, target_index=None, sensitive_name='sex', sensitive_index=8, log_data=True,
        ...
        self.data_writer.writerow(
            ['ID','ID2', 'Feature', 'Feature2','swap_proportion', 'Acc', 'Acc_after', 'distortion_multiple', 'distortion_feature', 'hellinger_div','wasserstein_div','cramers_v_div', 'total_variation_div', 'KL_div', 'JS_Div', 'Casuality', 'Importance','effect_distance', 'effect_distance_contrained', 'SP', 'SP_after',
        ...
        self.data_writer2.writerow(
            ['ID', 'ID2', 'Feature', 'Feature2','Category1', 'Category2', 'swap_proportion', 'Acc', 'Acc_after', 'distortion_multiple', 'distortion_feature', 'hellinger_div', 'wasserstein_div', 'cramers_v_div', 'total_variation_div', 'KL_div',
    ...
    def compute_(self, data_category, perc_parity, x_test_altered, random_index_, category_indices, y_predicted_before, y_predicted_after, p_pred, q_pred, column_id, column_id2, val, val2, category_1, category_2, distortion_multiple, distortion_feature):
        ...
        if len(val) > 0 and len(category_target_predicted_before) > 0:
            ...
            data_category[category_1][category_2]['ACC'] = round(acc_category * 100 / len(category_target_original), 3)
            data_category[category_1][category_2]['TPR'] = TPR
            data_category[category_1][category_2]['FPR'] = FPR
            data_category[category_1][category_2]['distortion_multiple'] = distortion_multiple
            data_category[category_1][category_2]['distortion_feature'] = distortion_feature

            data_category[category_1][category_2]['SP'] = SP
            data_category[category_1][category_2]['ACC_after'] = round(acc_category_after * 100 / len(category_target_original),
                                                         3)
            data_category[category_1][category_2]['TPR_after'] = TPR_after
            data_category[category_1][category_2]['FPR_after'] = FPR_after
            data_category[category_1][category_2]['SP_after'] = SP_after
            data_category[category_1][category_2]['proportion'] = round(proportion * 100 / len(category_target_original), 3)
            data_category[category_1][category_2]['Importance'] = round(f_importance * 100 / len(category_target_original), 3)
            data_category[category_1][category_2]['hellinger_div'] = hellinger_mean
            data_category[category_1][category_2]['wasserstein_distance_div'] = wasserstein_mean
            data_category[category_1][category_2]['cramers_v_div'] = cramers_v_mean
            data_category[category_1][category_2]['total_variation_div'] = total_variation_mean
            data_category[category_1][category_2]['effect_distance'] = effect_distance_mean
            data_category[category_1][category_2]['effect_distance_contrained'] = effect_distance_contrained_mean

            data_category[category_1][category_2]['KL_Divergence'] = kl_mean
            data_category[category_1][category_2]['JS_Divergence'] = js_mean
    ...
    def fit_nn(self, iterations=10, swap_proportion=[0.1, 0.3, 0.5, 0.7]):
                ...
                for column_id in range(self.x_train.shape[1]):
                    ...
                    for key,val in data_category_after.items():
                        self.data_writer2.writerow(
                            ['F_{}'.format(column_id), 'F_{}'.format(column_id), self.colums_list[column_id],
                             self.colums_list[column_id], key, key, swap_proportion_,
                    ...
                    for column_id2 in range(self.x_train.shape[1]):
                        if column_id != column_id2:
                            ...
                            distortion_multiple, distortion_feature = hellinger_distortion, hellinger_distortion
                            ...
                            for key, val in data_category_2_columns_after.items():
                                for key2, val2 in val.items():
                                    ...
                                    '''
                                    self.data_writer2.writerow(
                                        ['F_{}'.format(column_id), 'F_{}'.format(column_id2), self.colums_list[column_id],self.colums_list[column_id2], key, key2, swap_proportion_,
                                         val2['ACC'],
                                         val2['ACC_after'],
...
if __name__ == '__main__':
    ...
    data_name = 'adult-{}_'.format(alpha)  # _35_threshold
