...
class SensitivityAnalysis:
    ...
    def fit_nn(self, iterations=10, swap_proportion=[0.1, 0.15, 0.2,  0.4, 0.6,  0.8, 0.95]):
...
if __name__ == '__main__':
    ...
    data_name = 'cleveland-45_v2_50_'  # _35_threshold
    ...
    train, test, target_index = load_data.load_clevelan_heart(data_name)
