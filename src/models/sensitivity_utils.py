...
def alter_feature_values_categorical(test_data, posible_values=[0,1],feature_index=0, swap_proportion=0.01):
    new_test_data = []
...
def alter_feature_value_continous(test_data, posible_values={},feature_index=0, swap_proportion=0.01):
    new_test_data = []
    #_,random_index_ = data_split(data=random_index, sample_size=swap_proportion)
    for i in range(len(test_data)):
        #if i in random_index_:
