...
class SensitivityAnalysis:
    def __init__(self, data,df_data, target_index=None, sensitive_name='sex', sensitive_index=8, log_data=True,
                 log_path='../dataset/logging4/', data_name='', colums_list=[], threshold=None):
        self.data = data
        ...
        print('self.sensitive_index: ', self.sensitive_index)
        ...
        self.log_path_global = log_path + 'Divergence_global_{}.csv'.format(data_name)
        ...
        self.log_path_local = log_path + 'Divergence_local_{}.csv'.format(data_name)
...
if __name__ == '__main__':
    ...
    data_name = 'Student_'  # _35_threshold
    ...
    #data = loadData.discretized(df_adult)
    ...
    #train, test, target_index = load_data.load_compas(data_name)
