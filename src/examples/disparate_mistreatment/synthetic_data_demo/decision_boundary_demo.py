import os,sys
import numpy as np
from src.examples.disparate_mistreatment.synthetic_data_demo.generate_synthetic_data import *
sys.path.insert(0, '../../fair_classification/') # the code for fair classification is in this directory
import src.examples.fair_classification.utils as ut
import src.examples.fair_classification.funcs_disp_mist as fdm
import src.examples.disparate_mistreatment.synthetic_data_demo.plot_syn_boundaries as psb
