...
#import utils as ut
#from src.examples.fair_classification import utils
from cvxpy.lin_ops.lin_utils import sum_entries

from src.examples.fair_classification import utils as ut
